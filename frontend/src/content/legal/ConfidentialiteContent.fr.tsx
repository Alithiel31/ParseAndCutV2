...
// Contenu français de la politique de confidentialité. Garder en
// synchronisation manuelle avec ConfidentialiteContent.en.tsx (traduction
// MVP, pas de garantie juridique).
export default function ConfidentialiteContentFr() {
  return (
    <>
      <p>

...
// Contenu français des mentions légales. Garder en synchronisation manuelle
// avec MentionsLegalesContent.en.tsx (traduction MVP, pas de garantie
// juridique).
export default function MentionsLegalesContentFr() {
  return (
    <>
      <h3>Éditeur</h3>
      <p>
